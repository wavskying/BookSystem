...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-danger layui-btn" lay-event="more">详情</a>
    ...
    layui.use(['element', 'layer', 'util','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'photo', title: '照片', width:'15%', sort: true, fixed: 'left' ,templet: '<div><img src="data:image/png;base64,{{d.photo}}" /> </div>'}
                ,{field: 'name', title: '名字', width:'20%'}
                ,{field: 'introduction', title: '简介', width:'25%', sort: true}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.open({
                    title:'详细信息'
                    ,type:2
                    ,content: "../web/AuthorOpen.jsp?name="+data.name
                    ,area: ['1000px', '630px']
                });
            }
        });
