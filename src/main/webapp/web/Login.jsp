...
<script>
    ...
    function login() {
        if (!validateCode('#loginCard','#loginCode')){
            ...
            var params = {'username':loginUsername,
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (data.result == 'success'){
                        var power = data.user.identity;
                        var photo = data.user.image;
                        var name = data.user.name
                        window.location.href = '../web/Index.jsp?power='+power+'&photo='+photo+'&name='+name;
                    }
                },
                error:function () {
                    alert("111")
    ...
    <div class="registerDiv">
        <form>
            ...
            <div class="usernameWrapDiv">
                ...
                <div class="usernameDiv">
                    <i class="layui-icon layui-icon-username adminIcon"></i>
                    <input id="registerName" class="layui-input adminInput" type="text" name="username" placeholder="输入姓名" >
                </div>
            </div>
            <div class="usernameWrapDiv">
                <div class="usernameLabel">
